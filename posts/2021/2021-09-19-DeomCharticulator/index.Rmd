...
```{r, echo=FALSE}
knitr::include_graphics('./img/fig-03.gif')
```
...
```{r, echo=FALSE}
knitr::include_graphics('./img/fig-04.gif')
```
...
```{r, echo=FALSE}
knitr::include_graphics('./img/fig-05.gif')
```
...
```{r, echo=FALSE}
knitr::include_graphics('./img/fig-06.gif')
```
...
```{r, echo=FALSE}
knitr::include_graphics('./img/fig-07.gif')
```
